    ...
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden group hover:shadow-lg transition-shadow duration-200">
      ...
      <div className="p-4 space-y-2">
        <div className="space-y-1">
          ...
          <h3 className="text-sm text-gray-700 line-clamp-2">{perfume.name}</h3>
          {perfume.description && (
            <p className="text-xs text-gray-500">{perfume.description}</p>
          )}
        </div>
        ...
        <div className="pt-2 space-y-3">
          ...
          <Button className="w-full bg-sage-600 hover:bg-sage-700 text-white py-2.5 text-sm font-medium">
            В корзину
          </Button>
        </div>
      </div>
